<div class="bg-white rounded-lg border border-gray-200 p-6">
  ...
  <p class="text-gray-500 mb-2">Inicio: <?= date('F j, Y, g:i A', strtotime($event['start_time'])); ?></p>

  <?php if ($event['end_time']): ?>
  <p class="text-gray-500 mb-4">Fim: <?=date('F j, Y, g:i A', strtotime($event['end_time']))?></p>
  <?php endif; ?>

  <p class="text-gray-500 mb-4">Localização: <?=htmlspecialchars($event['location'])?></p>
