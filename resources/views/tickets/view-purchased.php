    ...
    <table class="min-w-full bg-white border border-gray-300 rounded-lg">
      <thead>
        <tr class="bg-gray-100">
          <th class="py-3 px-4 text-left text-sm font-medium text-gray-700 border-b">ID do Ingresso</th>
          <th class="py-3 px-4 text-left text-sm font-medium text-gray-700 border-b">ID do Evento</th>
